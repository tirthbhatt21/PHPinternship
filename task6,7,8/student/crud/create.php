...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($head_err) && empty($content_err) && empty($tags_err)){
        ...
        $sql = "INSERT INTO std_tbl (st_name,st_gender,st_dob,st_email,st_mobile,st_address,st_password,st_area,st_pincode,st_blodgroup) VALUES (?,?,?,?,?,?,?,?,?,?)";
                ...
                <div class="col-md-12">
                    ...
                    <form action="read.php" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($content_err)) ? 'has-error' : ''; ?>">
                            <label>Gender</label>
                            <select name="gender" class="form-control" value="<?php echo $tags; ?>">
                        ...
                        <div class="form-group <?php echo (!empty($tags_err)) ? 'has-error' : ''; ?>">
                            <label>DOB</label>
                            <input type="date" name="tags" class="form-control" value="<?php echo $tags; ?>">
                        ...
                        <div class="form-group <?php echo (!empty($head_err)) ? 'has-error' : ''; ?>">
                            <label>Mobile</label>
                            <input type="number" name="head" class="form-control" value="<?php echo $head; ?>">
                            <span class="help-block"><?php echo $head_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($head_err)) ? 'has-error' : ''; ?>">
                            <label>Address</label>
                            <textarea name="head"  cols="20" rows="05" class="form-control" value="<?php echo $head; ?>"></textarea>
                            <span class="help-block"><?php echo $head_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($head_err)) ? 'has-error' : ''; ?>">
                            <label>Password</label>
                            <input type="password" name="head" class="form-control" value="<?php echo $head; ?>">
                            <span class="help-block"><?php echo $head_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($head_err)) ? 'has-error' : ''; ?>">
                            <label>Area</label>
